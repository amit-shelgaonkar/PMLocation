...
class SMCoreDataManager: NSObject {
...
lazy var managedObjectModel: NSManagedObjectModel = {
    ...
    let modelURL = Bundle.main.url(forResource: "LogsModel", withExtension: "momd")!
...
lazy var persistentStoreCoordinator: NSPersistentStoreCoordinator = {
    ...
    do {
        ...
        Log.addMessage("Unresolved error \(wrappedError), \(wrappedError.userInfo)")
        abort()
    }
    return coordinator
}()
...
func saveContext () {
    if managedObjectContext.hasChanges {
        do {
            ...
            Log.addMessage("Unresolved error \(nserror), \(nserror.userInfo)")
            abort()
        }
    }
}
